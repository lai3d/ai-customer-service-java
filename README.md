...
- [ ] **17 · Channel and connector** — an embeddable [web widget](docs/widget.md) on the customer's own page, with widget keys bound to origins *(built)*; one real order connector (Shopify or Youzan) behind `OrderLookup`, chosen by the first pilot *(next)*
